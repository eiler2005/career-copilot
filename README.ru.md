...
| Найти и оценить роли | `career-job-search` | Итоги сбора, отбор по профилю с объяснением, почему вакансия ваша или нет, запросы вида `инженер + ai`, исходные условия и объяснённый результат соответствия |
...
| [Релевантность профилю](docs/ru/RELEVANCE.md) | Какие вакансии подходят профилю и почему: функция, уровень, домены резюме, запросы, ступени и настройка |
