...
| `preparation_briefs`, `track_plans`, `practice_sessions`, `practice_attempts`, `practice_reviews` | Vacancy briefs with provenance; plans for general gaps or baseline; practice questions, answers (artifacts) with retry/follow-up links and reviews (see [preparation](PREPARATION.md#preparation-module-two-entries-and-a-practice-cycle)) |
