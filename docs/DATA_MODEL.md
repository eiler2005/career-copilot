...
| `preparation_overviews` | Unified agent-authored review of both tracks with evidence-labelled themes, a weekly plan or calendar-free learning areas per role family, question bank, stories and CV advice (see [preparation](PREPARATION.md#preparation-module-two-entries-and-a-practice-cycle)) |
